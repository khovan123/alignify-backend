...
public class EmailService {
    ...
    public void sendOtpEmail(String to, String otp) {
        ...
        try {
            ...
            helper.setSubject("Alignify: Your OTP Code");
            String htmlContent = """
                <!DOCTYPE html>
                <html lang="en">
                <head>
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            <h1>Verify Your Alignify Account</h1>
                            <p class="instructions">Use the One-Time Password (OTP) below to verify your account. This code is valid for 10 minutes.</p>
                            <div class="otp-code">%s</div>
                            <p class="instructions">Enter this code on the verification page to complete your action.</p>
                            <a href="https://alignify.com/verify" class="button">Verify Now</a>
                        </div>
                        <div class="footer">
                            <p>If you didn’t request this code, please ignore this email or contact support at <a href="mailto:support@alignify.com">support@alignify.com</a>.</p>
